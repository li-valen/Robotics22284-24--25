...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -1977.9313556494483; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 2053.9641336219256; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -166.7517725485387; // x position of the perpendicular encoder (in tick units)
    }
